        ...
        <div class="container-fluid h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-12 col-sm-8">
                    ...
                    <marquee>Welcome to European U21 Championship News!</marquee>                        <marquee behavior="alternate">Welcome to European U21 Championship News!</marquee>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="videomag-main-menu" id="sticker">
       ...
       if (isset($_SESSION['UserName']) && $_SESSION['UserName']){?>
        ...
        <div class="dropdown-menu" style="width:15%;">
            <a class="dropdown-item" href="single.php">Change password <i class='far fa-address-card'></i></a>
...
<script src="js/active.js"></script>
  ...
  <script type="text/javascript">
    $('.passCofi').each(function(){
        swal("Warning", "Confirm New Password does not match:)", "warning");
    });
  </script>
  <script type="text/javascript">
